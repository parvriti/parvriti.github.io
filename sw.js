/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v62';
var CORE = [
  'index.html', 'open-when.html', 'board.html', 'doodles.html', 'periods.html', 'settings.html', 'dev.html',
  'css/styles.css?v=62', 'css/theme.css?v=62',
  'js/common.js?v=62', 'js/open-when.js?v=62', 'js/board.js?v=62', 'js/doodle.js?v=62',
  'js/periods.js?v=62', 'js/settings.js?v=62', 'js/dev.js?v=62', 'js/native.js?v=62',
