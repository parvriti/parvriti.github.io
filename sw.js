/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v81';
var CORE = [
  'index.html', 'open-when.html', 'board.html', 'doodles.html', 'periods.html', 'settings.html', 'dev.html',
  'css/styles.css?v=81', 'css/theme.css?v=81',
  'js/common.js?v=81', 'js/open-when.js?v=81', 'js/board.js?v=81', 'js/doodle.js?v=81',
  'js/periods.js?v=81', 'js/settings.js?v=81', 'js/dev.js?v=81', 'js/native.js?v=81',
