/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v80';
var CORE = [
  'index.html', 'open-when.html', 'board.html', 'doodles.html', 'periods.html', 'settings.html', 'dev.html',
  'css/styles.css?v=80', 'css/theme.css?v=80',
  'js/common.js?v=80', 'js/open-when.js?v=80', 'js/board.js?v=80', 'js/doodle.js?v=80',
  'js/periods.js?v=80', 'js/settings.js?v=80', 'js/dev.js?v=80', 'js/native.js?v=80',
