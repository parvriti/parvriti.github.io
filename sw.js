/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v75';
var CORE = [
  'index.html', 'open-when.html', 'board.html', 'doodles.html', 'periods.html', 'settings.html', 'dev.html',
  'css/styles.css?v=75', 'css/theme.css?v=75',
  'js/common.js?v=75', 'js/open-when.js?v=75', 'js/board.js?v=75', 'js/doodle.js?v=75',
  'js/periods.js?v=75', 'js/settings.js?v=75', 'js/dev.js?v=75', 'js/native.js?v=75',
