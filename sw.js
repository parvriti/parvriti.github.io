/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v25';
var CORE = [
  'index.html', 'open-when.html', 'wedding.html', 'board.html', 'doodles.html',
  'css/styles.css?v=25',
  'js/common.js?v=25', 'js/locks.js?v=25', 'js/open-when.js?v=25', 'js/board.js?v=25', 'js/doodle.js?v=25',
