/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v24';
var CORE = [
  'index.html', 'letter.html', 'open-when.html', 'wedding.html', 'room.html',
  'css/styles.css?v=24',
  'js/common.js?v=24', 'js/locks.js?v=24', 'js/open-when.js?v=24', 'js/room.js?v=24',
