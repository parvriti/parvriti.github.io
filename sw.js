/* =====================================================================
   ...
   ===================================================================== */
var CACHE = 'parvriti-v63';
var CORE = [
  'index.html', 'open-when.html', 'board.html', 'doodles.html', 'periods.html', 'settings.html', 'dev.html',
  'css/styles.css?v=63', 'css/theme.css?v=63',
  'js/common.js?v=63', 'js/open-when.js?v=63', 'js/board.js?v=63', 'js/doodle.js?v=63',
  'js/periods.js?v=63', 'js/settings.js?v=63', 'js/dev.js?v=63', 'js/native.js?v=63',
